 ...
 * descriptions can also be loaded through a Java {@link java.util.ResourceBundle}. This
...
public class JMXBeanWrapper implements DynamicMBean {
     ...
     *
     * @param bean The bean object which acts as a proxy target.
     *
     ...
     *
     * @param signature String array of parameter class names.
     * @param method    The method to check for a match.
     *
     ...
     *
     * @param bean The annotated object to wrap.
     *
